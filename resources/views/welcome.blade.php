                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="portfolio-title section-title mt-md-2">
                                ...
                                <a href="{{ route('events.home') }}" class="button mt-30 btn-sm">Voir toutes les images</a>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            <div class="feature-text p-4 mb-30 gray-bg border border-default text-center">
                                <div class="feature-icon">
                                    <span aria-hidden="true" class="fa fa-headphones mb-2 display-3"></span>
                                </div>
                                <div class="fature-info">
                                    ...
                                    <a class="button mt-20" href="#">Détails &raquo;</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="feature-text p-4 mb-30 gray-bg border border-default text-center">
                                <div class="feature-icon">
                                    <span aria-hidden="true" class="fa fa-music mb-2 display-3"></span>
                                </div>
                                <div class="fature-info">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="feature-text p-4 mb-30 gray-bg border border-default text-center">
                                <div class="feature-icon">
                                    <span aria-hidden="true" class="fa fa-book mb-2 display-3"></span>
                                </div>
                                <div class="fature-info">
